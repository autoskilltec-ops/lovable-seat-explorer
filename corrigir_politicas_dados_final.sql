-- CORREÇÃO DAS POLÍTICAS RLS PARA ACESSO AOS DADOS (VERSÃO FINAL)
-- Execute este script no SQL Editor do Supabase

-- 1. Remover TODAS as políticas existentes das tabelas de dados
...
DROP POLICY IF EXISTS "Admins can manage bus seats" ON bus_seats;
