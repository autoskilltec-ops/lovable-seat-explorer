...
ALTER TABLE bus_seats DROP CONSTRAINT IF EXISTS bus_seats_trip_id_seat_number_key;
...
-- Criar nova constraint única que considera bus_id
ALTER TABLE bus_seats ADD CONSTRAINT bus_seats_bus_id_seat_number_unique UNIQUE (bus_id, seat_number);